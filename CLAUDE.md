# Family Zoo — v13 — Custom Actions — Claude Project Memory
...
**Name:** Family Zoo — v13 — Custom Actions
**Purpose:** Sharpee tutorial step 13 — Custom Actions.
...
**Repository:** https://github.com/Johnesco/familyzoo-v13
**Live:** https://johnesco.github.io/familyzoo-v13/
...
├── familyzoo-13.js         the built story bundle
...
The steps are **generated**, not hand-edited: each one is `familyzoo.story` sliced to the blocks introduced at or before this step, with per-step room prose so a description never names a thing the step has not created yet. Change the master and the step map, then re-lay the steps — do not hand-edit `familyzoo-v13.story`.
